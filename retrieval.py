...
if __name__ == '__main__':
    ...
    parser.add_argument("--index_file", type=str, default=os.path.join(BASE_DIR, 'index', 'train2.h5'), help="index file path.")
    ...
    # 1.图片推理
    model = ViTNet()
    query_vector = model.vit_extract_feat(args["test_data"])
    # 2.图片检索
